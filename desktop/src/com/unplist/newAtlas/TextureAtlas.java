...
public class TextureAtlas implements Disposable {
    ...
    static public class TextureAtlasData {
        ...
        final Array<TextureAtlasData.Region> regions = new Array();
        ...
        public void load (FileHandle packFile, FileHandle imagesDir, boolean flip) {
            ...
            ObjectMap<String, Field<TextureAtlasData.Page>> pageFields = new ObjectMap(15, 0.99f); // Size needed to avoid collisions.
            ...
            ObjectMap<String, Field<TextureAtlasData.Region>> regionFields = new ObjectMap(127, 0.99f); // Size needed to avoid collisions.
            regionFields.put("xy", new Field<TextureAtlasData.Region>() { // Deprecated, use bounds.
                public void parse (TextureAtlasData.Region region) {
                    region.left = Integer.parseInt(entry[1]);
                    region.top = Integer.parseInt(entry[2]);
                }
            });
            regionFields.put("size", new Field<TextureAtlasData.Region>() { // Deprecated, use bounds.
                public void parse (TextureAtlasData.Region region) {
            ...
            regionFields.put("offset", new Field<TextureAtlasData.Region>() { // Deprecated, use offsets.
                public void parse (TextureAtlasData.Region region) {
                    region.offsetX = Integer.parseInt(entry[1]);
                    region.offsetY = Integer.parseInt(entry[2]);
                }
            });
            regionFields.put("orig", new Field<TextureAtlasData.Region>() { // Deprecated, use offsets.
                public void parse (TextureAtlasData.Region region) {
